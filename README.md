# costctl — XBrain W6 side challenge starter (G11)
...
# On Windows without make, you can run:
python -m pytest -q
...
- [x] Replace `g<N>` placeholders throughout README with group number 11
...
Suggested post (G11):
`G11 — <repo-url> — 25/25 tests passing — implemented: list, terminate, clean`
